...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nfoursid-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14931&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nfoursid-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nfoursid` can be installed with:

```
conda install nfoursid
```

It is possible to list all of the versions of `nfoursid` available on your platform with:
